...
- Last couple days before deadline: Phyo and Sameer carried out user evaluation after the game was complete. Alex after completing the achievements package has assigned to the rest of the members to create new achievements to make the game more interesting. David added snapshots and diagrams webpage as well as finalised the snapshots gantt.
